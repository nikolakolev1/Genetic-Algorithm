    ...
    public static void main(String[] args) {
        try {
            for (int testNo = 0; testNo < 1; testNo++) {
                ...
                Presets.preset("AocTorAocFtxAriEltAoc"); // BolTorMboSinUnfEltMed | BolTorLboSinUnfEltMed | BolTorQdeSinUnfEltQde | TspTorTspPmxInvEltTsp | FtxTorNvpFtxAriEltFtx | AocTorAocFtxAriEltAoc
